...
kubectl apply -f postgres-db/horizontalpodautoscaler.yaml
kubectl apply -f pingpong-backend-postgres/manifest/deployment.yaml
kubectl apply -f pingpong-backend-postgres/manifest/horizontalpodautoscaler.yaml
...
kubectl apply -f ping-pong/manifest/horizontalpodautoscaler.yaml
...
kubectl apply -f main-app/manifest/horizontalpodautoscaler.yaml
